...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--num_grasp_clusters', type=int, default=32) #32
        ...
        self.parser.add_argument('--checkpoints_dir',
                                 type=str,
                                 default='./checkpoints_wrap',  #evaluator: chekpoint---random  checkpoints_mug farthest
