...
#
    ...
    def read_object_grasp_data(
        ...
        object_model = sample.Object(os.path.join(root_folder,mesh_fname))
...
if __name__ == '__main__':
    ...
    #grasp_paths = os.path.join(args.root_folder, 'grasps/grasp_Mug') + '/Mug_10f6e09036350e92b3f21f1137c3c347_0.00028563716822276134.h5' #success--shapenetCore
